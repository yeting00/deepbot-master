package com.perspicace.ai.deepbot.repository;
...
public interface CommonRedisDao {
     ...
     * 移除list中值为某一值的元素
     *  destiny
     * @param count =0 删除等于value的所有元素 count> 0：删除等于从头到尾移动的值的元素 count <0：删除等于从尾到头移动的值的元素。
     * @return
     */
    boolean removeListfValue(String key, long count, String value);
