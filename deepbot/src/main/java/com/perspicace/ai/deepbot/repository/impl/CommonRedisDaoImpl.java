...
public class CommonRedisDaoImpl implements CommonRedisDao {
     ...
     * 前缀
     */
    private static final String KEY_PREFIX_VALUE = "ai:deepbot:value:";
    private static final String KEY_PREFIX_SET = "ai:deepbot:set:";
    private static final String KEY_PREFIX_LIST = "ai:deepbot:list:";
    ...
    public String getValue(String k) {
        try {
            ...
            log.error ( "获取缓存失败key[" + KEY_PREFIX_VALUE + k + ", Codeor[" + t + "]" );
        }
        return null;
    }
...
//            listOps.rightPop ( key );
            ...
            log.error ( "移除list缓存失败key[" + KEY_PREFIX_LIST + k + ", Codeor[" + t + "]" );
        }
        return false;
    }

    @Override
    public boolean removeListfValue(String k, long count, String value){
        String key = KEY_PREFIX_LIST + k;
        try {
    ...
    public Set<String> getSet(String k) {
        try {
            ...
            log.error ( "获取set缓存失败key[" + KEY_PREFIX_SET + k + ", Codeor[" + t + "]" );
        }
        return null;
    }
...
//            listOps.leftPush ( key , v );
    ...
    public List<String> getList(String k , long start , long end) {
        try {
            ...
            log.error ( "获取list缓存失败key[" + KEY_PREFIX_LIST + k + ", Codeor[" + t + "]" );
        }
        return null;
    }
    ...
    public long getListSize(String k) {
        try {
            ...
            log.error ( "获取list长度失败key[" + KEY_PREFIX_LIST + k + "], Codeor[" + t + "]" );
        }
        return 0;
    }
